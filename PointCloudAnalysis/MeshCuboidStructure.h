...
public:
	...
	inline unsigned int num_null_sample_points() const;

	unsigned int num_cuboids_sample_points() const;
	...
	bool save_null_sample_points_to_ply(const char *_file_name, bool _verbose = true) const;
	bool save_null_sample_points(const char *_filename, bool _verbose = true) const;
	...
	bool load_samples_label(const char *_filename, bool _verbose = true);
