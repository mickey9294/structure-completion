	...
	Eigen::MatrixXd &_quadratic_term, Eigen::VectorXd &_linear_term, double& _constant_term) const
{
	...
	const unsigned int mat_size = _quadratic_term.cols();  /* num_cuboids * 24 */
	const unsigned int num_corners = MeshCuboid::k_num_corners;  /* 8 */
	const unsigned int num_attributes = MeshCuboidAttributes::k_num_attributes;  /* 24 */

	// X: sample points, Y: cuboid surface points.
	unsigned int num_X_points = num_sample_points;  /* the number of sample points */
	unsigned int num_Y_points = num_cuboid_surface_points;  /* the number of cuboid surface points */
	...
	Eigen::VectorXd x = attribute.get_attributes();  /* corners attributes of the cuboid */
