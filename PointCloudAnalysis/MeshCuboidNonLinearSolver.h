...
private:
	...
	const Real squared_neighbor_distance_;  /* 0.05 * 0.05 * object_diameter */
	...
	const unsigned int num_reflection_symmetry_group_variables_;  /* 3 + 1 = 4*/
	const unsigned int num_rotation_symmetry_group_variables_;  /* 3 + 3 = 6 */
};
