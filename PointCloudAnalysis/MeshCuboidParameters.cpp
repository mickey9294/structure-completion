...
DEFINE_bool(disable_part_relation_terms, false, "");
// ---- //
...
DEFINE_string(sample_label_path, "data/4_experiments/exp1_coseg_chairs/1_prediction/", "");

DEFINE_string(retrieval_label_info_path, "data/0_body/coseg_chairs/", "");
DEFINE_string(retrieval_mesh_path, "data/1_input/coseg_chairs/off/", "");
DEFINE_string(retrieval_sample_path, "data/2_analysis/coseg_chairs/points/even1000/", "");
DEFINE_string(retrieval_dense_sample_path, "data/2_analysis/coseg_chairs/points/random100000/", "");
DEFINE_string(retrieval_mesh_label_path, "data/1_input/coseg_chairs/gt/", "");
DEFINE_string(retrieval_sample_label_path, "data/4_experiments/exp1_coseg_chairs/1_prediction/", "");
