	...
	const char *_output_file_prefix)
{
	...
	std::cout << "dense_sample_filepath: " << dense_sample_filepath << std::endl;
	...
	std::cout << "_mesh_filepath: " << _mesh_filepath << std::endl;
	ret = load_object_info(ground_truth_mesh, ground_truth_cuboid_structure,
		_mesh_filepath, LoadGroundTruthCuboids);
	assert(ret);
	output_filename_sstr.clear(); output_filename_sstr.str("");
	output_filename_sstr << _output_file_prefix << std::string("_origin");
	ground_truth_cuboid_structure.save_sample_points_to_ply(output_filename_sstr.str().c_str());
	ground_truth_cuboid_structure.save_sample_point_labels((output_filename_sstr.str() + std::string("_label.arff")).c_str());
	...
	std::cout << "Before recon by symmetry, cuboid: " << cuboid_structure_.num_sample_points() << "; gt: " << ground_truth_cuboid_structure.num_sample_points()
		<< "; copy: " << cuboid_structure_copy.num_sample_points() << std::endl;
	...
	std::cout << "Before recon by data, cuboid: " << cuboid_structure_.num_sample_points() << "; gt: " << ground_truth_cuboid_structure.num_sample_points()
		<< "; copy: " << cuboid_structure_copy.num_sample_points() << std::endl;

	output_filename_sstr.clear(); output_filename_sstr.str("");
	output_filename_sstr << _output_file_prefix << std::string("_save_1");
	evaluator.evaluate_point_to_point_distances(&cuboid_structure_, output_filename_sstr.str().c_str());
	cuboid_structure_.save_sample_points_to_ply(output_filename_sstr.str().c_str());
	...
	std::cout << "Before fusion, cuboid: " << cuboid_structure_.num_sample_points() << "; gt: " << ground_truth_cuboid_structure.num_sample_points()
		<< "; copy: " << cuboid_structure_copy.num_sample_points() << std::endl;

	output_filename_sstr.clear(); output_filename_sstr.str("");
	output_filename_sstr << _output_file_prefix << std::string("_save_2");
	evaluator.evaluate_point_to_point_distances(&cuboid_structure_, output_filename_sstr.str().c_str());
	cuboid_structure_.save_sample_points_to_ply(output_filename_sstr.str().c_str());
	...
	std::cout << "After fusion, cuboid: " << cuboid_structure_.num_sample_points() << "; gt: " << ground_truth_cuboid_structure.num_sample_points()
		<< "; copy: " << cuboid_structure_copy.num_sample_points() << std::endl;
	...
	evaluator.evaluate_point_to_point_distances(&cuboid_structure_, output_filename_sstr.str().c_str());
	cuboid_structure_.save_sample_points_to_ply(output_filename_sstr.str().c_str());
	cuboid_structure_.check_null_sample_points();
	cuboid_structure_.save_null_sample_points_to_ply(output_filename_sstr.str().c_str());
	cuboid_structure_.save_sample_points((output_filename_sstr.str() + std::string(".pts")).c_str());
	cuboid_structure_.save_null_sample_points((output_filename_sstr.str() + std::string("_null.pts")).c_str());
	cuboid_structure_.save_sample_point_labels((output_filename_sstr.str() + std::string("_label.arff")).c_str());
	...
	std::cout << "At the end, cuboid: " << cuboid_structure_.num_sample_points() << "; gt: " << ground_truth_cuboid_structure.num_sample_points()
		<< "; copy: " << cuboid_structure_copy.num_sample_points() << std::endl;
